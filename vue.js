...
Dep.prototype.depend = function depend () {
  console.log('Dep.prototype.depend')
  if (Dep.target) {
...
function pushTarget (_target) {
  console.log('pushTarget:', _target);
...
function observe (value, asRootData) {
  console.log('observe value asRootData', value, asRootData)
...
function defineReactive (
  ...
  console.log('defineReactive', { obj: obj, key: key, val: val });
  var dep = new Dep();
  ...
  Object.defineProperty(obj, key, {
    ...
    get: function reactiveGetter () {
      console.log('Object.defineProperty get reactiveGetter')
      var value = getter ? getter.call(obj) : val;
      if (Dep.target) {
        console.log('call dep.depend();')
        dep.depend();
        if (childOb) {
          childOb.dep.depend();
          if (Array.isArray(value)) {
...
var Watcher = function Watcher (
  ...
  console.log('new Watcher vm expOrFn cb options isRenderWatcher', vm, expOrFn, cb, options, isRenderWatcher);
  this.vm = vm;
  if (isRenderWatcher) {
    vm._watcher = this;
  }
...
Watcher.prototype.get = function get () {
  console.log('Evaluate the getter, and re-collect dependencies')
  console.log('Watcher.prototype.get');
  pushTarget(this);
  var value;
  var vm = this.vm;
  try {
...
Watcher.prototype.addDep = function addDep (dep) {
  console.log('Watcher.prototype.addDep:', dep);
  var id = dep.id;
...
Watcher.prototype.depend = function depend () {
  console.log('Watcher.prototype.depend');
    var this$1 = this;
...
function createElement (
  ...
  console.log('createElement', {context: context, tag: tag, data: data, children: children});
...
function initMixin (Vue) {
  Vue.prototype._init = function (options) {
    console.log('Vue._init options:', options);
    var vm = this;
    // a uid
    vm._uid = uid$3++;
    ...
    console.log('vm.$options after mergeOptions', vm.$options);
    /* istanbul ignore else */
    {
      initProxy(vm);
    }
...
function resolveConstructorOptions (Ctor) {
  console.log('resolveConstructorOptions Ctor:', Ctor)
  var options = Ctor.options;
  console.log('resolveConstructorOptions options:', options)
  if (Ctor.super) {
...
Vue.prototype.$mount = function (
  ...
  console.log('public Vue.prototype.$mount');
